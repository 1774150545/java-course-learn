...
public class ValuePassing {
	...
	public static void main(String[] args) {      
		...
		Point2D point2=new Point2D(200,300);
		Point2D point3=new Point2D(400,500);
		System.out.println("before chaning:");
		System.out.println("str1是:"+point1);
		System.out.println("str2是:"+point2);
		System.out.println("str3是:"+point3);
		change(point1,point2,point3);
		System.out.println("after chaning:");
		System.out.println("str1是:"+point1);
		System.out.println("str2是:"+point2);
		System.out.println("str3是:"+point3);
    }
	public static void change(Point2D p1,Point2D p2,Point2D p3) {  
		float x=3333;
		p1.setX(x);
